...
WebUI.setText(findTestObject('E3 - Frame Payment List Method/Text Field Expiration date'), '1')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Text Field CVV Number'))

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Invalid Expiration detail'), 'Invalid expiration detail.')
