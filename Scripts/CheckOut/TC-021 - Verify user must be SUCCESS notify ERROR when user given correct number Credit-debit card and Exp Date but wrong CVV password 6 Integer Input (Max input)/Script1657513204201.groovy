...
WebUI.setText(findTestObject('E3 - Frame Payment List Method/Text Field Expiration date'), '1025')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Text Field CVV Number'))

WebUI.setText(findTestObject('E3 - Frame Payment List Method/Text Field CVV Number'), '123123')
...
WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Verify Payment data is invalid'), 'Payment data is invalid')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Button Retry Payment data is invalid'))

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Error when CVV wrong in the card number text field'), 'Card got declined by the bank. Try using another card/payment method.')
