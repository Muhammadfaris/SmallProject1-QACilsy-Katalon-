...
WebUI.click(findTestObject('E3 - Frame Payment List Method/Button Back on CC method to Payment List Method'))

WebUI.click(findTestObject('E3 - Frame Payment List Method/Button No on confirmation Credit debit card'))
