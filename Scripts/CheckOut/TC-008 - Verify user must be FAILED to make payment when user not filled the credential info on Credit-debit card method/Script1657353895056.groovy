...
WebUI.click(findTestObject('E3 - Frame Payment List Method/Button Pay Now inActive'))

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Please enter your card number'), 'Please enter your card number.')

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Expiry cant be empty'), 'Expiry can\'t be empty.')

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text CVV cant be empty'), 'CVV can\'t be empty.')
