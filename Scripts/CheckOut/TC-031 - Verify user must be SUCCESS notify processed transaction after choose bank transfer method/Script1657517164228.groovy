...
WebUI.click(findTestObject('E3 - Frame Payment List Method/Button Action Bank Transfer'))

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Title after Payment list method'), 'Bank transfer')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Button Bank Mandiri Payment'))

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Bold Header Merchant after choose merchant bank'), 
    'Bank Mandiri')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Text Action How to pay'))

WebUI.click(findTestObject('E3 - Frame Payment List Method/Button List M Banking'))

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Verify M Banking Intruction'), 'Payment complete.')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Button I Have Paid Bank Transfer'))

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text notif transaction processed'), 'Your transaction is being processed')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Button Back to merchants'))

WebUI.switchToDefaultContent()

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text we booked your payment'), 'We\'ve booked your payment.')
