...
WebUI.setText(findTestObject('E3 - Frame Payment List Method/Text Field CVV Number'), '1')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Text Field Expiration date'))

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Invalid CVV'), 'Invalid CVV.')
