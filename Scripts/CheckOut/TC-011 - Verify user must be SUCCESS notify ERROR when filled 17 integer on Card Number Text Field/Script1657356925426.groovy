...
WebUI.setText(findTestObject('E3 - Frame Payment List Method/Text Field Credit Card Number'), '11111111111111112')

WebUI.click(findTestObject('E3 - Frame Payment List Method/Text Field Expiration date'))

WebUI.verifyElementText(findTestObject('E3 - Frame Payment List Method/Text Make sure your card number correct'), 'Make sure your card number are correct.')
